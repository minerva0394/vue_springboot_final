...
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` (`id`, `name`, `path`, `icon`, `description`, `pid`) VALUES (2, '主页', '/home', 'el-icon-s-home', '描述1', NULL);
INSERT INTO `sys_menu` (`id`, `name`, `path`, `icon`, `description`, `pid`) VALUES (4, '系统管理', NULL, 'el-icon-menu', NULL, NULL);
INSERT INTO `sys_menu` (`id`, `name`, `path`, `icon`, `description`, `pid`) VALUES (5, '用户管理', '/user', 'el-icon-s-custom', NULL, 4);
INSERT INTO `sys_menu` (`id`, `name`, `path`, `icon`, `description`, `pid`) VALUES (6, '角色管理', '/role', 'el-icon-s-platform', NULL, 4);
INSERT INTO `sys_menu` (`id`, `name`, `path`, `icon`, `description`, `pid`) VALUES (7, '菜单管理', '/menu', 'el-icon-s-data', NULL, 4);
INSERT INTO `sys_menu` (`id`, `name`, `path`, `icon`, `description`, `pid`) VALUES (8, '文件管理', '/file', 'el-icon-document', NULL, 4);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` (`id`, `name`, `description`) VALUES (1, 'test', 'test测试');
INSERT INTO `sys_role` (`id`, `name`, `description`) VALUES (2, 'test2', '角色管理test2');
INSERT INTO `sys_role` (`id`, `name`, `description`) VALUES (3, 'test3', '角色测试3');
INSERT INTO `sys_role` (`id`, `name`, `description`) VALUES (4, '管理员', '管理员');
INSERT INTO `sys_role` (`id`, `name`, `description`) VALUES (5, 'admin', 'admin');
INSERT INTO `sys_role` (`id`, `name`, `description`) VALUES (6, '用户', '用户');
INSERT INTO `sys_role` (`id`, `name`, `description`) VALUES (7, '运营商', '运营商');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (3, '0320', '12345665433213', 'nickTest3', 'test3@mail', 'testphone', '3321312313', '2022-03-20 11:30:07', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (4, '4', '4', '4567', '4', '4', 'test0321_4', '2022-05-21 19:52:51', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (6, '6', '6', '6', '6', '6', '6', '2022-05-19 23:53:57', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (7, '7', '7', '7', '7', '7', '7‘’', '2022-05-19 23:54:03', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (8, '8', '8', '8', '8', '8', '8', '2022-05-19 23:54:07', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (9, '9', '9', '9', '9', '9', '9', '2022-05-19 23:54:12', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (10, '10', '10', '10', '10', '10', '10', '2022-05-19 23:54:23', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (11, '11', '11', '11', '11', '11', '11', '2022-05-19 23:54:31', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (12, '12', '12', '12', '12', '12', '12', '2022-07-19 23:54:37', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (13, '13', '13', '1', '13', '13', '13', '2022-07-19 23:54:44', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (14, '14', '14', '14', '14', '14', '14', '2022-09-19 23:54:50', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (15, '15', '15', '15', '151', '15', '15', '2022-11-19 23:55:01', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (17, 'abc', NULL, '23343', '副书记艾', '飞机啊是', '甲方ifdsf', '2022-08-20 19:42:13', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (18, 'testzzl', NULL, 'zzl', 'zzl@zzl.com', '123', '123', '2022-11-20 21:51:28', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (19, '0321', NULL, '0321', 'test', '12', '24', '2022-11-21 20:00:16', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (20, 'test24', NULL, 'test_jfios_sfjiof ', 'ioweafji', 'fjio2j2', 'fjisdao', '2022-02-21 20:01:48', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (21, '这是一个测试', NULL, '测试', '24@jio.com', '214dsaffdsaf', 'fjio', '2022-12-21 21:10:20', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (22, 'sbVUE', NULL, '哪个傻逼', '会觉得', '前端', '有意思？', '2022-06-21 21:48:55', NULL);
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (26, 'test导入测试', '423', '发窘', '发电量数据库', '的飞机噢is', '剪短发哦哦； ', '2022-02-21 23:02:29', '');
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (27, 'zzl', '123456', 'zzl', 'zzl', 'zzl', 'zzl', '2022-12-22 18:26:43', 'https://avatar.csdnimg.cn/9/0/2/0_weixin_44359517.jpg');
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (29, 'test2', '111111', 'test2', NULL, NULL, NULL, '2022-12-22 11:38:00', 'http://localhost:9091/file/5d972ca209ce4923a4fd0c31f1df403b.jpg');
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (30, 'test导入测试', '423', '发窘', '发电量数据库', '的飞机噢is', '剪短发哦哦； ', '2022-06-22 12:12:11', '');
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (31, 'admin', 'admin', 'admin', NULL, NULL, NULL, '2022-06-23 01:57:51', 'http://localhost:9091/file/a022536d9fbb497fb78578ab619ec5a4.jpg');
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `createTime`, `avatar`) VALUES (33, 'test', 'test', 'test', 'test', 'test', NULL, '2022-03-23 22:20:12', NULL);
COMMIT;
